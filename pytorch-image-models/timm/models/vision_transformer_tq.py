...
class TQ_VisionTransformer(nn.Module):
    ...
    def __init__(
            ...
            dic_n=None, dic_dim=4, tq_type='TQ', tq_level=[3,3,3,3], tq_Tinit=1 # default tq_level is set to [3,3,3,3] in TQ-ViT
    ):
        """
        Args:
...
default_cfgs = {
    ...
    'tq_vit_small_patch16_384': _cfg(input_size=(3, 384, 384),crop_pct=1.0), # 384x384
    'tq_vit_base_patch16_384': _cfg(input_size=(3, 384, 384),crop_pct=1.0), # 384x384
}
